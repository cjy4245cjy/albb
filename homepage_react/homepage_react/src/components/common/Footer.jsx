        ...
        <div className='main-page'>
          <div style={{overflow:'hidden',marginTop:0}}>
            <div style={{float:'left',width:538}}>
              <QueueAnim className='bottom-contact-list' component="ul" type={["bottom","top"]}>
                <li key={1} style={{fontSize:'18px'}}><a style={{color:'#fff'}} >关于我们</a></li>
            ...
            <QueueAnim className='bottom-desc-groups' component="div" type={["bottom","top"]}>
